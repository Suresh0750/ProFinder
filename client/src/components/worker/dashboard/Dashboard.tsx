    ...
    return(
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">${data?.ResentActivity[0]?.totalPayment}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{data?.ResentActivity[0]?.countIsCompleteTrue}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{data?.ResentActivity[0]?.countIsCompleteFalse}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{data?.ResentActivity[0]?.pendingPayment}</div>
              <p className="text-xs text-muted-foreground">From {data?.ResentActivity[0]?.pendingCustomer} customers</p>
            </CardContent>
          </Card>
        </div>
